    ...
    methods: {
        async fetchWarranties() {
            try {
                ...
                const response = await this.$axios.get('/api-auth/warranty/level1/', {
                    headers: {
                ...
                const responseLevel2 = await this.$axios.get('/api-auth/warranty/level2/', {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                });
        ...
        async submitPayment(warranty) {
            ...
            await this.$axios.post('/api-auth/warranty/level2/submit/', formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
